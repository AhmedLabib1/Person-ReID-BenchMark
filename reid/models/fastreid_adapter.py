...
def load_model_spec(
    ...
    official = selected_model["official_dukemtmc"]
...
class FastReIDAdapter:
    """
    Unified inference interface for official
    DukeMTMC-trained FastReID checkpoints.
    """
    ...
    def _build_config(self):
        ...
        # Full DukeMTMC-trained checkpoint is available.
        # Do not load ImageNet initialization first.
    ...
    def source_dataset(
        ...
        return self.spec.source_dataset
    ...
    def encode(
        ...
        L2 normalization belongs to the SHAWAF
        ...
        if embeddings.ndim != 2:
            raise RuntimeError(
                "Expected FastReID output shape "
                "[B, D], got "
