# Vendored from KaiyangZhou/deep-person-reid (MIT): torchreid/models/osnet_ain.py
# ImageNet auto-download removed; we load the Deep OC-SORT ReID checkpoint ourselves.
